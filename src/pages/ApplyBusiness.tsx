    ...
    <div className="container mx-auto py-12">
      ...
      {submitted ? (
        ...
        <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); setSubmitted(true); }}>
          <input required className="w-full rounded-md bg-background border border-white/10 px-3 py-2" placeholder="Business name" />
          <input required type="email" className="w-full rounded-md bg-background border border-white/10 px-3 py-2" placeholder="Contact email" />
          <input className="w-full rounded-md bg-background border border-white/10 px-3 py-2" placeholder="Website or social links" />
